        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            <button
              ...
              className="absolute left-1 md:-left-14 top-1/2 -translate-y-1/2 z-20 w-11 h-11 bg-white/10 hover:bg-ibiza-red rounded-full flex items-center justify-center text-white transition-all duration-300 shadow-lg"
            >
            ...
            <button
              ...
              className="absolute right-1 md:-right-14 top-1/2 -translate-y-1/2 z-20 w-11 h-11 bg-white/10 hover:bg-ibiza-red rounded-full flex items-center justify-center text-white transition-all duration-300 shadow-lg"
            >
